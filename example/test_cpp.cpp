...
int main(int argc, char **argv)
{
  ...
  try
  {
    ...
    geo->wire(0, 4096, -0.048, 0.021, -0.005, 0.035, 0.043, 0.014, 0.001, 1.0, 1.0);  // 70
    geo->wire(0, 4096, 0.017, -0.015, 0.014, -0.027, 0.04, -0.031, 0.001, 1.0, 1.0);  //66
    geo->wire(0, 4096, 0.046, -0.01, 0.028, -0.013, -0.005, 0.031, 0.001, 1.0, 1.0);  //47
    geo->wire(0, 4096, -0.048, -0.038, -0.04, 0.049, -0.045, -0.04, 0.001, 1.0, 1.0); //77
